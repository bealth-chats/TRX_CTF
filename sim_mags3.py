...
print("Sum of sorted mags for secret1:", np.sum(np.sort(np.abs(v0_1))))
print("Sum of sorted mags for secret2:", np.sum(np.sort(np.abs(v0_2))))

# What about the sum of magnitudes to the power of 4?
print("Sum of mags^4 for secret1:", np.sum(np.abs(v0_1)**4))
print("Sum of mags^4 for secret2:", np.sum(np.abs(v0_2)**4))
